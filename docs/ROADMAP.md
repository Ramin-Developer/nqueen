...
> BenchmarkDotNet validation after reducing DFS cancellation polling frequency and removing
> redundant row clearing improved N=16 from 199.1 ms to 178.8 ms and N=17 from 1,453.5 ms
> to 1,420.1 ms.
